...
#ifndef CDB_GEOMETRYTECHNIQUE
#define CDB_GEOMETRYTECHNIQUE 1
...
class GeometryTechnique : public osgTerrain::TerrainTechnique {
public:
...
protected:
    ...
    virtual osg::Vec3d computeCenterModel(BufferData &buffer, osgTerrain::Locator *masterLocator);

    virtual void generateGeometry(BufferData &buffer, osgTerrain::Locator *masterLocator,
