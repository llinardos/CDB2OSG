...
#ifndef CDB_UREFPATHSOLVER_H
#define CDB_UREFPATHSOLVER_H
...
namespace CDB {
    ...
    class URefPathSolver : public CDB::FolderNameSolver, public CDB::FileNameSolver {
        
    public:
        
        URefPathSolver(const URef &uRef);
